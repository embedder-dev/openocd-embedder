...
seo_title: Version 0.10.0-20161028*-dev released
description: Version 0.10.0-201610281609-dev is a maintenance release. It includes binaries for Windows of GNU ARM Eclipse OpenOCD.
keywords:
  - xpack
  - openocd
  - release
