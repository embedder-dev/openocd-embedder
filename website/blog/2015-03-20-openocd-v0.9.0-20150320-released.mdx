...
seo_title: Version 0.9.0-20150320*-dev released
description: Version 0.9.0-20150320* is a new release of GNU ARM Eclipse OpenOCD.
keywords:
  - xpack
  - openocd
  - release
...
Version **0.9.0-20150320*** is a new release; the latest development version of OpenOCD (**0.9.0-dev**) is now available as multiple platform specific binary packages.
