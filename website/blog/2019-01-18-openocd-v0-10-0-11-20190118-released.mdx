...
seo_title: Version 0.10.0-11-20190118 released
description: Version 0.10.0-11-20190118 is a maintenance release of GNU MCU Eclipse OpenOCD.
keywords:
  - xpack
  - openocd
  - release
...
Version **0.10.0-11-20190118** is a maintenance release; it updates to the latest master and removes the RISC-V patches.
