...
const config: Config = {
    ...
    [
      'classic',
      {
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/openocd-xpack/blog/archive/**',
            '/openocd-xpack/blog/authors/**',
            '/openocd-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/openocd-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/openocd-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/openocd-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/openocd-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, openocd'
      }
    ],
    navbar: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub openocd-xpack project',
              href: 'https://github.com/xpack-dev-tools/openocd-xpack/',
            },
            {
