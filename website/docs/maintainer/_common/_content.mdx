...
and fix them; assign them to a milestone (like <code>0.12.0-4</code>).
...
- add a new entry like _**\* v0.12.0-4 prepared**_
- commit with the message _**prepare v0.12.0-4**_
...
tagged like **v0.12.0-4** (mind the dash in the middle!) and
named like **xPack OpenOCD v0.12.0-4** (mind the dash),
...
- commit with the message _**website: blog post release 0.12.0-4 published**_
...
- commit all changes with the message
  _**package.json: update urls for 0.12.0-4.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v0.12.0-4.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v0.12.0-4.1**_
...
- switch to https://xpack-dev-tools.github.io/openocd-xpack/docs/maintainer/#update-the-xpack-branch
...
- paste the release name like _**xPack OpenOCD v0.12.0-4 released**_
