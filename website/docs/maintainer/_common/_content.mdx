...
import CommonProjectMoreRepos from '../_project/_more-repos.mdx';
import CommonProjectCheckUpstreamRelease from '../_project/_check-upstream-release.mdx';
import CommonProjectUpdateVersionSpecific from '../_project/_update-version-specific.mdx';
...
**@xpack-dev-tools/openocd** is an xpm package that packs platform specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
<CommonProjectCheckUpstreamRelease/>
...
<CommonProjectUpdateVersionSpecific/>
