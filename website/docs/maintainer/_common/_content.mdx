...
(such as **0.12.0-6.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v0.12.0-6 released**_
...
tagged such as **v0.12.0-6** (mind the dash in the middle!) and
named such as **xPack OpenOCD v0.12.0-6** (mind the dash),
