...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/xpack-dev-tools/openocd-xpack.git/website run generate-website-blog-post
  ```
...
- **Commit** with the message _**website: blog post release 0.12.0-7.1 published**_
