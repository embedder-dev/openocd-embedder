...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm run generate-website-blog-post -C ~/Work/xpack-dev-tools/openocd-xpack.git/website
  ```
...
- **Commit** with the message _**website: blog post release 0.12.0-6.1 published**_
