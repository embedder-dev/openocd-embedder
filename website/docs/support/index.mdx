...
# How to obtain help for xPack OpenOCD
...
- Review the [GitHub Discussions](https://github.com/xpack-dev-tools/openocd-xpack/discussions) for
similar topics
- Examine the [GitHub Issues](https://github.com/xpack-dev-tools/openocd-xpack/issues)
tracker and the
[GitHub Pull Requests](https://github.com/xpack-dev-tools/openocd-xpack/pulls)
for similar problems.
...
others, please 
utilise the [GitHub Discussions](https://github.com/xpack-dev-tools/openocd-xpack/discussions)
pages.
