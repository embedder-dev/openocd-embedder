...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/openocd@0.12.0-5.1 --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/openocd/0.12.0-5.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/openocd/0.12.0-5.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/openocd/0.12.0-5.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-openocd-0.12.0-5-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-0.12.0-5</code>.
...
<ul>
<li><code>xpack-openocd-0.12.0-5-darwin-x64.tar.gz</code></li>
<li><code>xpack-openocd-0.12.0-5-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/openocd/xpack-openocd-0.12.0-5</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/openocd
cd ~/Library/xPacks/openocd

tar xvf ~/Downloads/xpack-openocd-0.12.0-5-darwin-x64.tar.gz
chmod -R -w xpack-openocd-0.12.0-5
`} </CodeBlock>
...
<ul>
<li><code>xpack-openocd-0.12.0-5-linux-x64.tar.gz</code></li>
<li><code>xpack-openocd-0.12.0-5-linux-arm64.tar.gz</code></li>
<li><code>xpack-openocd-0.12.0-5-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/openocd/xpack-openocd-0.12.0-5</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/openocd
cd ~/.local/xPacks/openocd

tar xvf ~/Downloads/xpack-openocd-0.12.0-5-linux-x64.tar.gz
chmod -R -w xpack-openocd-0.12.0-5
`} </CodeBlock>
