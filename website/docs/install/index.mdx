...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/openocd@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<ul>
<li><code>xpack-openocd-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
<ul>
<li><code>xpack-openocd-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-openocd-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
<ul>
<li><code>xpack-openocd-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-openocd-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-openocd-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
